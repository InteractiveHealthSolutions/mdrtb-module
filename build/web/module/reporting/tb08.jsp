...
function fun1()
{
	...
	if(val!="")
		window.location.replace("/openmrs/module/mdrtb/reporting/tb08.form?ob="+val+"&yearSelected="+year+"&quarterSelected="+quarter+"&monthSelected="+month)
}
...
function fun2()
{
	...
	var month =  "\"" + document.getElementById("month").value +  "\"";
	if(val2!="")
		window.location.replace("/openmrs/module/mdrtb/reporting/tb08.form?loc="+val2+"&ob="+val1+"&yearSelected="+year+"&quarterSelected="+quarter+"&monthSelected="+month)
}
