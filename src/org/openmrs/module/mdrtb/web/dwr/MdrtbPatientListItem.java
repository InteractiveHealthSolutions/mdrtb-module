...
public class MdrtbPatientListItem extends PersonListItem {
	...
	public MdrtbPatientListItem() {
	}
	
	public MdrtbPatientListItem(Patient patient) {
		super(patient);
	...
	public boolean equals(Object obj) {
		if (obj instanceof MdrtbPatientListItem) {
			MdrtbPatientListItem pi = (MdrtbPatientListItem) obj;
