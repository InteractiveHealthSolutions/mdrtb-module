...
<td>${tb03u.relapseMonth.displayString}</td>
</tr>
...
<td><input name="tb03RegistraionNumber" size="12" value="${tb03u.tb03RegisrationNumber}"/></td>
</tr>
...
<c:forEach var="status" items="${mdrstatuses}">
	<option value="${status.concept.id}" <c:if test="${tb03u.mdrStatus == status.concept}">selected</c:if> >${status.concept.displayString}</option>
</c:forEach>
</select>
</td>
</tr>
...
<td><openmrs_tag:dateField formFieldName="treatmentStartDate" startValue="${tb03u.treatmentStartDate}"/></td>
</tr>
...
<option value=""></option>
<c:forEach var="relapseOption" items="${relapseds}">
	<option value="${relapseOption.concept.id}" <c:if test="${tb03u.relapsed == relapseOption.concept}">selected</c:if> >${relapseOption.concept.displayString}</option>
</c:forEach>
</select>
</td>
</tr>
