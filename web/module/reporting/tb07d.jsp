...
function fun1()
{
	...
	if(val!="")
		window.location.replace("${pageContext.request.contextPath}/module/mdrtb/reporting/tb07d.form?ob="+val+"&yearSelected="+year+"&quarterSelected="+quarter+"&monthSelected="+month)
}
...
function fun2()
{
	...
	if(val1==${dushanbe}) {
		...
		if(e.selectedIndex!=0) {
			document.getElementById("facility").setSelectedIndex(0);
		}
	...
	var month =  "\"" + document.getElementById("month").value +  "\"";
	if(val2!="")
		window.location.replace("${pageContext.request.contextPath}/module/mdrtb/reporting/tb07d.form?loc="+val2+"&ob="+val1+"&yearSelected="+year+"&quarterSelected="+quarter+"&monthSelected="+month)
}
