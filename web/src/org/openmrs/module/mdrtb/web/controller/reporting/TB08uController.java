...
public class TB08uController {
    ...
    public static String doTB08(
    	...
    	boolean reportStatus = Context.getService(MdrtbService.class).readReportStatus(report_oblast, location.getId(), year, report_quarter, report_month, "TB-08u","MDRTB");
